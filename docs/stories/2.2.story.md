...
- [x] Task 3: Create ChatViewModel (AC: 1, 2, 3, 4, 5, 6, 7, 8, 9)
...
- [x] Task 5: Implement Message Bubble Component (AC: 2, 6)
...
- [x] Task 9: Update Conversation Metadata on Message Send (AC: 4)
